        ...
        $(document).ready(function () {
            $.getJSON('LayerNCC.json', function(pmInfo){
                ...
                for (var k = 0; k < pmInfo.length; k++) {
                    ...
                    var sitename = pmInfo[k].Site_Name;

                    var sitedesc = pmInfo[k].Site_Description;

                    var pictures = pmInfo[k].Picture_Location;

                    var sitelink = pmInfo[k].Link_to_site_location;
...
//             console.log(RGB);
            ...
            var ImageLibrary = WorldWind.configuration.baseUrl + "images/Pics/" ;// location of the image files
        ...
        var handleMouseCLK = function (a)   {
            ...
            for (var m = 0; m < pickListCLK.objects.length; m++) {
                console.log (pickListCLK.objects[m].position);
